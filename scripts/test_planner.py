...
for student in all_students:
    ...
    if topics:
        ...
        # if len(topics) > 5:
        #     print(f"     ... and {len(topics)-5} more weeks until Week {topics[-1]['week']}")
    else:
